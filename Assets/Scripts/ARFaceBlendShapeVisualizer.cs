...
public class ARFaceBlendShapeVisualizer : MonoBehaviour
{
    ...
    private const int BlendShapeIndexMouthA = 0; // 'I(이)' 에서 'A(아)'로 수정 
    ...
    void CheckValue()
    {
        ...
        EyeBlinkText.text = "왼쪽 눈 값 : " + LeftEyeBlinkValue + "\n" + "오른쪽 눈 값 : " + RightEyeBlinkValue;
        EyeMoveText.text = "눈동자 "+ "\n" + "위 : "+ LookUpValue + "\n" + "아래 : " + LookDownValue + "\n" +
                            "왼쪽 : " + LookLeftValue + "\n" + "오른쪽 : " + LookRightValue;
        MouthText.text = "입(아) : " + MouthAValue;
